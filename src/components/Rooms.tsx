...
const rooms = [
  ...
  },
  {
    ...
    icon: Users,
    tariff: '₹4600',
    features: ['2 Air Conditioned', 'Spacious', 'Hot Water', 'TV'],
  ...
  },
  {
    ...
    icon: Calendar,
    tariff: '₹6000',
    features: ['3 Air Conditioned', '2 King Size Bed', '2 Bathroom','TV'],
    description: 'Premium suite with multiple AC units, king size beds, and private bathrooms',
  },
  {
    id: 5,
    name: 'Auditorium',
